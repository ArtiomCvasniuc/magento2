...
abstract class Tests extends Action {
    /**
     * Core registry
     *
    ...
    protected function _isAllowed() {
        // echo $this->_authorization->isAllowed ( 'Apptha_Marketplace::manage_commission' );
        // exit('OK');
        return $this->_authorization->isAllowed ( 'Apptha_Marketplace::manage_commission' );
    }
}
