...
class Data extends AbstractHelper {
    ...
    public function showCategoriesTree($categoryName, $catIds) {
        ...
        $array = '<select onchange="get_subcategory();" id="get_sub" class="form-control" name="product_category" required><option></option>';
        foreach ( $categoryName as $key => $catname ) {
            ...
            if (strstr ( $key, 'sub' )) { 
                ...
                // echo $key . ' ';
                // echo $catname . ' ' . 'cat' . $key . '<br />';
                // echo $catname . ' '  . $key . '_span' .'<br />';
                ...
                $array .= '<option class="" value="' . $key.$catname . '" id="'. $key .'">' . $catname .'';
            } 
            // else {
