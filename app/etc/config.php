...
return [
    'modules' => [
        ...
        'Mageplaza_StoreSwitcher' => 1,
        'Magestat_SplitOrder' => 1,
        'MaxMage_AjaxShoppingCartPage' => 1,
        'PHPCuong_AjaxAddToCart' => 1,
        'RLTSquare_AjaxShoppingCartUpdate' => 1,
        'Sebwite_SmartSearch' => 1,
        'StripeIntegration_Payments' => 1,
        'Temando_Shipping' => 1,
        'TheCodingTutor_Sortby' => 1,
        'Themevast_BestsellerProduct' => 1,
        'Themevast_Blog' => 1,
        'Themevast_Brand' => 1,
        'Themevast_Categorytab' => 1,
        'Themevast_CustomMenu' => 1,
        'Themevast_Featuredpro' => 1,
        'Themevast_HotDeals' => 1,
        'Themevast_MegaMenu' => 1,
        'Themevast_Newproduct' => 1,
        'Themevast_Onsaleproduct' => 1,
        'Themevast_PriceCountdown' => 1,
        'Themevast_ProductTab' => 1,
        'Themevast_QuickView' => 1,
        'Themevast_SearchbyCat' => 1,
        'Themevast_SlideBanner' => 1,
        'Themevast_Testimonials' => 1,
        'Themevast_Themeoption' => 1,
        'Themevast_Themevast' => 1,
        'Themevast_ThemevastUp' => 1,
        'Tukan_Checkout' => 1,
        'Tukan_FixUiComponent' => 1,
        'Vertex_Tax' => 1,
        'Zone_AdvancedSortBy' => 1
    ]
];
